...
class OptionPositionInfo:
    ...
    This is a class to hold meta data for a position.
    """
    def __init__(self, ticker: str, exp:str, strike: int = None, moneyness: float = None, exposure: str = "long", otype: str = None, quantity: int = 1) -> None:
        self.ticker: str = ticker
        self.exp: str = exp
...
class PortfolioInfo:
    ...
    def add_option(self, ticker: str, exp: str, strike: int = None, moneyness: float = None, exposure: str = "long", otype: str = "call", quantity: int = 1) -> None:
        position = OptionPositionInfo(ticker = ticker, exp = exp, strike = strike, moneyness=moneyness, exposure=exposure, otype=otype, quantity=quantity)
