...
from option_data import OptionNode, TODAY
...
Note: This class is strictly for calculating options when we pass in our OptionNode data, later we will create a seperate module in this 
directory for regular greek formulas I define. We might make it so the greeks withing this module use the formulas from greek_formulas.py, the 
only issue with this is it violates the Dependency Inversion principle in SOLID
