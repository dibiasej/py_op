...
def load_data_to(ticker):
    ...
    #call_file_path: str = directory + f"/{ticker}_call" + f"_2024-08-27"
    #put_file_path: str = directory + f"/{ticker}_put" + f"_2024-08-27"
...
def load_data_from(ticker, date) -> (dict, dict):
    ...
    call_path: str = DIR + ticker + f"/{ticker}_call" + f"_{date}"
    put_path: str = DIR + ticker + f"/{ticker}_put" + f"_{date}"
...
if __name__ == "__main__":
    ...
    #SingleDownload().normal_load("Z")
    #t = test()
    #print(t)
    print(SingleUpload().upload_chain("NVDA", "2024-08-30"))